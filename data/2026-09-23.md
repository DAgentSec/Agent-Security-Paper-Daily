...
### [1] [Rethinking Backdoor Repair Evaluation: Distinguishing Aggregate Clean Utility from Benign Performance Preservation](https://arxiv.org/abs/2609.25579)
...
### [2] [Recursive self-improvement of AI research agents](https://arxiv.org/abs/2609.26457)
...
### [3] [Evaluating Coding Agents on Kernel Exploit Generation](https://arxiv.org/abs/2609.25591)
...
### [4] [Rouxii: Exploiting Honeypots with Deception-Aware AI Pentesters](https://arxiv.org/abs/2609.26555)
...
### [5] [Attack Success Rate Is Not a Number: On Measurement Validity in Agentic AI Security Evaluation](https://arxiv.org/abs/2609.25173)
...
### [6] [Quantum ROP: Using Quantum Algorithms for ROP Chain Selection in Exploit Construction](https://arxiv.org/abs/2609.25364)
*Carlos Benitez*
...
### [7] [Policy-Backed Selective Regeneration under Tainted Inter-Agent Communication](https://arxiv.org/abs/2609.26072)
...
### [8] [FinFIRST: Benchmarking Search Agents for Financial Information Retrieval, Sourcing and Traceability](https://arxiv.org/abs/2609.25192)
...
### [9] [Passes Alone, Fails Together: Benchmarking Semantic Coordination in Parallel LLM-Agent Development](https://arxiv.org/abs/2609.25396)
...
### [10] [Qwen3.8-Omni: Towards Native Omni-Modal Agents](https://arxiv.org/abs/2609.25611)
* Qwen Team*
...
### [12] [Agensh: Scaling Organizational Intelligence to 1,024 Agents](https://arxiv.org/abs/2609.26781)
...
### [13] [Trains but Doesn't Learn: A Post-Training Delivery Benchmark for LLM Agents as Forward-Deployed Engineers](https://arxiv.org/abs/2609.25237)
...
### [14] [Adversarial Course-of-Action Generation: Game-Theoretic Multi-Agent Algorithms for COA matching & COA generation](https://arxiv.org/abs/2609.26059)
...
### [15] [AgenticSizing: A Large Language Model-based Multi-Agent Framework for Analog Circuit Sizing](https://arxiv.org/abs/2609.25873)
...
### [16] [VACS: Value-Aligned Compositional Shielding for Multi-Agent Reasoning](https://arxiv.org/abs/2609.26135)
...
### [17] [The AI Neuroscientist: An Interactive Agentic Interface for Neuroimaging Analysis](https://arxiv.org/abs/2609.25254)
...
### [18] [When LLM Agents Fail to Read the Room: ReAdapt for Relational Social Reasoning](https://arxiv.org/abs/2609.25284)
...
### [19] [Learned Enterprise Data Comprehension: Compression and Routing for Data Agents](https://arxiv.org/abs/2609.25286)
...
### [20] [From Risk Scoring to Risk Allocation: A Density-Driven Framework for Diverse Monitoring in Multi-Agent Systems](https://arxiv.org/abs/2609.26146)
*Zhaohui Wang*
...
### [21] [MAGIC: Mixed-Granularity Agent Graphs via Incremental Construction with Dense-Reward Reinforcement Learning](https://arxiv.org/abs/2609.26667)
...
### [22] [Federating Quantum and Classical Computing: A Privacy-Preserving Hybrid Approach](https://arxiv.org/abs/2609.25082)
...
### [23] [Selection-Invariant Communication Compilers for Privacy-Aware Multi-Agent LLM Workflows](https://arxiv.org/abs/2609.26076)
*Jinghan Xu, Longze Fan, Zeyuan Wang, Xinjin Li, Hankai Liu*
...
### [24] [Self-Cleaning and Captured Anyway: One Measured Primitive for Error in a Store an Agent Writes to Itself, and What a Falling Score Actually Measures](https://arxiv.org/abs/2609.25052)
...
### [25] [FIRE: Failure-Informed Runtime Engineering for Reliable Language-Model Agents](https://arxiv.org/abs/2609.26048)
...
### [26] [Fully Byzantine-Resilient Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2609.25701)
...
### [27] [The Delegation Blind Spot: Auditing Product Decisions from Agent Choices](https://arxiv.org/abs/2609.26642)
*Shivam Gupta*
...
### [28] [CliffCompaction: Cost-Efficient Compaction for Long-Horizon Coding Agents](https://arxiv.org/abs/2609.26779)
...
### [29] ["As a Language Model...": Chat Template Switches LLM Self-Referential Voice and Activation Steering Reproduces It](https://arxiv.org/abs/2609.25021)
*Jędrzej Maczan*
...
### [31] [Towards Effective Black-Box Adversarial Attacks on Deep Code Models via Structural and Identifier Perturbations](https://arxiv.org/abs/2609.26234)
...
### [32] [A2M: Trace-Optimized Agent Hijacking in the MCP Ecosystem](https://arxiv.org/abs/2609.26761)
...
### [33] [How Strongly Should Task State Influence an LLM Agent?](https://arxiv.org/abs/2609.25686)
...
### [34] [DTOC: Dynamic Tool Output Compression for Adaptive Context Management in AI Agents](https://arxiv.org/abs/2609.26121)
...
### [35] [MAC-RRG: Iterative Multi-Agent Collaboration for X-ray Radiology Report Generation](https://arxiv.org/abs/2609.26124)
...
### [36] [Making Agents More Consistent: Skills Should Form Habits for Repeat Tasks](https://arxiv.org/abs/2609.25299)
